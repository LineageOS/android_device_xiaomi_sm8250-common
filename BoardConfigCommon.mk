...
BOARD_PRODUCTIMAGE_PARTITION_RESERVED_SIZE := $(shell echo ${FRAMEWORK_PARTITIONS_RESERVED_SIZE}*2 | bc)
BOARD_SYSTEMIMAGE_PARTITION_RESERVED_SIZE := $(shell echo ${FRAMEWORK_PARTITIONS_RESERVED_SIZE}/2 | bc)
BOARD_SYSTEM_EXTIMAGE_PARTITION_RESERVED_SIZE := $(shell echo ${FRAMEWORK_PARTITIONS_RESERVED_SIZE}/2 | bc)
else
